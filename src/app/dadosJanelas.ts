...
export const DADOSENTIDADES = {
    ...
    "#robodin": {
        ...
        titulo: "ROBODIN",
        text: "O RoboDIN é um projeto de ensino voltado para a área de robótica, com foco no desenvolvimento de atividades práticas e no aprimoramento do conhecimento técnico dos participantes. Através de aplicações práticas, busca incentivar e auxiliar os membros no seu processo de aprendizagem.",
        cor: "#2C8B8D",
    ...
    "#aaacex": {
        ...
        titulo: "AAACEX",
        text: "A Associação Atlética Acadêmica do Centro de Exatas tem foco na participação de jogos e treinamento de atletas, além da integração de estudantes das UEM. Também conta com o apoio da TED (Torcida Extremamente Desorganizada) e da Exateria, que é um bloco universitátario responsável por promover o contato com a música",
        cor: "#EE2825",
