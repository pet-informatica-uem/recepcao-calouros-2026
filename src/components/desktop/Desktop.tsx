...
import PopUpPeriodo from "./../popUpPeriodo";
              ...
              >
                <div className="flex flex-col space-y-8 md:space-y-12 text-center">
                  ...
                  {selectedDay.periods.map((period) => (
                    <div key={period.name} className="">
                      <PopUpPeriodo label={period} />
                      <div
                        key={period.name}
                            ...
                            >
                              ...
                              <div className="flex flex-wrap justify-center gap-2 md:gap-4">
                                {act.tags.map((tag) => (
                                  <span
                                    key={tag}
                                    className="border border-white px-3 py-1 text-base font-bold uppercase bg-black text-white"
                                  >
                                    {tag}
                                  </span>
                                ))}
